...
public class DeleteHouse implements Command {
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if(check == -1){
            ...
            houseService.deleteHouse(numberOfHouse);
            request.getRequestDispatcher("jsp/successfully.jsp").forward(request, response);
        }
    }
}
